...
DURATION_LIMIT_MIN = int(
    getenv("DURATION_LIMIT", "1420")
)  # Remember to give value in Minutes

# Duration Limit for downloading Songs in MP3 or MP4 format from bot
SONG_DOWNLOAD_DURATION = int(
    getenv("SONG_DOWNLOAD_DURATION_LIMIT", "1420")
)  # Remember to give value in Minutes
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "").split("1720846883"))
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/ygabutkan"
)  # Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/ygabutkan"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/elieve/m")
...
TG_VIDEO_FILESIZE_LIMIT = int(
    getenv("TG_VIDEO_FILESIZE_LIMIT", "104857600000")
)  # Remember to give value in bytes
